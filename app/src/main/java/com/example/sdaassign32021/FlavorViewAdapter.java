    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        viewHolder.itemParentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "onClick: I have clicked on the image" + mFlavors.get(position));

                Toast.makeText(mNewContext, mFlavors .get(position).getVersionName() + " Has Been Clicked!", Toast.LENGTH_SHORT).show();
            }
        });
    }
